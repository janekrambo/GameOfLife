...
int ProcessArray(bool** inArr, bool ** outArr){
	...
	int tmp = 0;
	int i;
    #pragma omp parallel default(none) private(i) shared(inArr, outArr, arrayDimension)
    {
        #pragma omp for schedule(static) private(tmp)
